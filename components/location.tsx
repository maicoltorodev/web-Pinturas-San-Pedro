...
export function Location() {
  // Lazy load iframe solo cuando está visible
  const [mapRef, isMapVisible] = useSharedIntersectionObserver<HTMLDivElement>({
    threshold: 0.1,
    rootMargin: '100px',
  })
                ...
                {isMapVisible ? (
                  ...
                  <div className="w-full h-[450px] bg-gradient-to-br from-primary/20 to-primary/10 flex items-center justify-center">
                    <div className="text-center">
                      <MapPin className="h-12 w-12 text-primary-foreground/40 mx-auto mb-4" />
